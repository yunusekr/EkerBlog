  ...
  return (
    <>
      <div className="h-[984px] w-[100%] flex flex-col justify-center items-center bg-[#F4F4F4] dark:bg-[#2A262B] max-md:justify-start  ">
        ...
        <div className="w-[161.33px] h-[161.33px] border-[1.5rem] border-[#D9D9D9] dark:border-[#525252] rounded-full ml-[46vw] z-[99] absolute flex items-center justify-center bottom-0 mb-[-10px] max-md:hidden"></div>
      </div>
    </>
  );
}
